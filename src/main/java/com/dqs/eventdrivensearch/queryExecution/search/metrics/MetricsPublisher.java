...
public class MetricsPublisher {
    public enum MetricNames {
        ...
        FINAL_RESULT_GENERATION_FOR_SINGLE_SPLIT, CREATE_MEMORY_MAPPED_DIRECTORY, READ_RESULTS, CREATE_SEARCHER, READ_SPLIT_AND_WRITE_LUCENE_SEGMENT, READ_SPLIT_FROM_S3,
        WRITE_RESULT_TO_S3_FOR_SINGLE_INDEX, CONTENT_GENERATION_FROM_SEARCH_RESULT, RESULT_PUT_OBJECT, NUMBER_OF_MATCHING_DOCS_IN_INDEX
    }
