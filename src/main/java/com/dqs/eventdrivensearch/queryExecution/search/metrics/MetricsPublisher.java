...
public class MetricsPublisher {
    public enum MetricNames {
        CONTENT_GENERATION_FROM_SEARCH_RESULT, CREATE_MEMORY_MAPPED_DIRECTORY, CREATE_SEARCHER, DOWNLOAD_INDEX_SHARD_LOAD_INTO_LUCENE_DIRECTORY_AND_SEARCH, DOWNLOAD_SINGLE_INDEX_SHARD, DOWNLOAD_SPLITS_LOAD_INTO_LUCENE_DIRECTORY_AND_SEARCH, FINAL_RESULT_GENERATION_FOR_SINGLE_SPLIT, INTERNAL_SEARCH_TIME,
        NUMBER_OF_MATCHING_DOCS_IN_INDEX, READ_RESULTS, READ_SPLIT_AND_WRITE_LUCENE_SEGMENT, READ_SPLIT_AND_CREATE_RAM_DIRECTORY, READ_SPLIT_FROM_S3, RESULT_PUT_OBJECT, SEARCH_SINGLE_INDEX_SHARD,
        SEARCH_SINGLE_SPLIT, UNZIP_SINGLE_INDEX_SHARD, WRITE_RESULT_TO_S3_FOR_SINGLE_INDEX, WRITE_RESULT_TO_S3_FOR_SINGLE_INDEX_SHARD,
        DOWNLOAD_UNZIP_AND_FINAL_RESULT_GENERATION_FOR_INDEX
    }
